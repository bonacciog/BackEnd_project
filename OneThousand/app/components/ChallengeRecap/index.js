                    ...
                    <View style={{flex:2, flexDirection:'row'}}>
                        ...
                        <View style={styles.avatarContainer}>
                            <Image
                                ...
                                style = {styles.avatar}
                            />
                            <Text style={styles.title}>{this.getUserNameFromUserId(this.props.Challenge.ReceiverProposal_ID)}</Text>
                        </View>
                    </View>    
...
export default connect(mapStateToProps, mapDispatchToProps)(ChallengeRecap)